#!/usr/bin/env Rscript
# Volve ReserveTW4 replication audit (Paper 1 revision, Phase 1).
#
...
#
# Usage:
#   Rscript experiments/run_volve_reservetw4.R [N_SEEDS] [SUBSAMPLE] [B]
...
cat(sprintf("Volve GR segment: n=%d, transition=%d (%.0f%%, %.0f m), reserve-test=%d rows\n\n",
...
stem <- if (N_SEEDS > 1) "volve_reservetw4_repeated" else "volve_reservetw4_single"
